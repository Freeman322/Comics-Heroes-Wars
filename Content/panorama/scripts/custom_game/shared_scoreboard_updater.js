	...
	if ( playerInfo )
	{
		...
		if ( playerPortrait )
		{
			if ( playerInfo.player_selected_hero !== "" )
			{
				...
				else if (playerInfo.player_selected_hero == "npc_dota_hero_rattletrap" && hasModifier(hero_entindex, "modifier_custom_unique"))
				{
				...
				else if (playerInfo.player_selected_hero == "npc_dota_hero_gyrocopter" && hasModifier(hero_entindex, "modifier_octavia"))
				{
				...
				else if (playerInfo.player_selected_hero == "npc_dota_hero_death_prophet" && hasModifier(hero_entindex, "modifier_rat"))
				{
					playerPortrait.SetImage( "file://{images}/custom_game/heroes/rat.png" );
				}
				else if (playerInfo.player_selected_hero == "npc_dota_hero_faceless_void" && hasModifier(hero_entindex, "modifier_rat"))
				{
					playerPortrait.SetImage( "file://{images}/custom_game/heroes/rat.png" );
				}
