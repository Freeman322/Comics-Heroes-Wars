...
function joker_suicide:OnSpellStart()
  if IsServer() then
    ...
    if Util:PlayerEquipedItem(self:GetCaster():GetPlayerOwnerID(), "joker_custom") then 
        local explosion2 = ParticleManager:CreateParticle("particles/econ/items/elder_titan/elder_titan_ti7/elder_titan_echo_stomp_ti7.vpcf", PATTACH_WORLDORIGIN, caster)
