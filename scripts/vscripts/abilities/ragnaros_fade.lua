...
function ragnaros_fade:OnSpellStart()
    ...
    if hTarget:GetHealth() > health then
        ...
        ApplyDamage ( { attacker = hCaster, victim = hTarget, ability = self, damage = health, damage_type = DAMAGE_TYPE_PURE, damage_flags = DOTA_DAMAGE_FLAG_NO_SPELL_AMPLIFICATION})
