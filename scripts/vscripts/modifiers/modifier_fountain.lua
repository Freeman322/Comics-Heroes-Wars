...
function modifier_fountain:GetAuraRadius() return 1100 end
...
function modifier_fountain_protection:IsHidden() return false end
function modifier_fountain_protection:DeclareFunctions() return { MODIFIER_PROPERTY_HEALTH_REGEN_PERCENTAGE, MODIFIER_PROPERTY_TOTALDAMAGEOUTGOING_PERCENTAGE } end
function modifier_fountain_protection:GetModifierHealthRegenPercentage(params) return HP_PERCENT_REGEN end
function modifier_fountain_protection:GetModifierTotalDamageOutgoing_Percentage(params) return DAMAGE_REDUCTION end
function modifier_fountain_protection:CheckState() return {[MODIFIER_STATE_INVULNERABLE] = true} end
