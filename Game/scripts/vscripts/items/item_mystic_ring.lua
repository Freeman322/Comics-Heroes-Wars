...
function modifier_item_mystic_ring:GetModifierSpellAmplify_Percentage() return self:GetAbility():GetSpecialValueFor("bonus_amp") end
...
function modifier_item_mystic_ring:GetModifierPercentageCooldown() return self:GetStackCount() * (self:GetAbility():GetSpecialValueFor("bonus_cooldown_reduction_per_soul") or 1) end
