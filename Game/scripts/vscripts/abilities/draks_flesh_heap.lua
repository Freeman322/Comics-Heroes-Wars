...
function modifier_draks_flesh_heap:OnHeroKilled(params)	if IsServer() then if not params.target:IsFriendly(params.attacker) then self:SetStackCount(self:GetStackCount() + 1) end end end
